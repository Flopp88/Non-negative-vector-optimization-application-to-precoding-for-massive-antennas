function[x_quant,summary_X_real,summary_U, xi] = c2po_sigm_opti(s,H,K,M,tau,tmax,delta,lambda)
...
x_quant_c2po = ampl*(sign(summary_X_real(1:M,end)) + 1i*sign(summary_X_real(M+1:2*M,end)));
